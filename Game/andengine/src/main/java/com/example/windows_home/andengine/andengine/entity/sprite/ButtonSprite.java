...
/**
 * Note: {@link com.example.windows_home.andengine.andengine.entity.sprite.ButtonSprite} needs to be registered as a {@link ITouchArea} to the {@link Scene} via {@link Scene#registerTouchArea(ITouchArea)}, otherwise it won't be clickable.
 * To make {@link com.example.windows_home.andengine.andengine.entity.sprite.ButtonSprite} function properly, you should consider setting {@link Scene#setTouchAreaBindingOnActionDownEnabled(boolean)} to <code>true</code>.
 *
 * (c) Zynga 2012
 *
