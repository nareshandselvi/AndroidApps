...
public class Scene extends Entity {
	 ...
	 * {@link com.example.windows_home.andengine.andengine.entity.scene.IOnAreaTouchListener#onAreaTouched(TouchEvent, com.example.windows_home.andengine.andengine.entity.scene.ITouchArea, float, float)}
	 ...
	 * <b>even if the {@link TouchEvent} is outside of the actual {@link com.example.windows_home.andengine.andengine.entity.scene.ITouchArea}</b>!
	 *
	 ...
	 * that are made with the same PointerID (finger)
	 * <b>even if the {@link TouchEvent} is would belong to an overlaying {@link com.example.windows_home.andengine.andengine.entity.scene.ITouchArea}</b>!
	 *
