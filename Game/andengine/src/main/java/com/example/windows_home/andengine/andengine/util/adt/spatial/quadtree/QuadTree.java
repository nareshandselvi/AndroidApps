package com.example.windows_home.andengine.andengine.util.adt.spatial.quadtree;
...
public abstract class QuadTree<B extends IBounds, T extends ISpatialItem<B>> implements IBounds {
	...
	public abstract class QuadTreeNode implements IBounds {
		...
		/**
		 * @return the items of this {@link com.example.windows_home.andengine.andengine.util.adt.spatial.quadtree.QuadTree.QuadTreeNode} and all children (recursively).
		 */
