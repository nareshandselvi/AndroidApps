...
public abstract class Texture implements ITexture {
	 ...
	 * @param pTextureStateListener to be informed when this {@link com.example.windows_home.andengine.andengine.opengl.texture.Texture} is loaded, unloaded or a {@link ITextureAtlasSource} failed to load.
	 */
