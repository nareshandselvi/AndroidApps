package com.example.windows_home.andengine.andengine.opengl.vbo;
...
/**
 * Compared to a {@link com.example.windows_home.andengine.andengine.opengl.vbo.HighPerformanceVertexBufferObject} or a {@link com.example.windows_home.andengine.andengine.opengl.vbo.LowMemoryVertexBufferObject}, the {@link com.example.windows_home.andengine.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} uses <b><u>no</u> permanent heap memory</b>,
 ...
 * <p/>
 * Usually a {@link com.example.windows_home.andengine.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} is preferred to a {@link com.example.windows_home.andengine.andengine.opengl.vbo.HighPerformanceVertexBufferObject} or a {@link com.example.windows_home.andengine.andengine.opengl.vbo.LowMemoryVertexBufferObject} when the following conditions are met:
 * <ol>
 * <li>The application is close to run out of memory.</li>
 * <li>You have very big {@link com.example.windows_home.andengine.andengine.opengl.vbo.HighPerformanceVertexBufferObject}/{@link com.example.windows_home.andengine.andengine.opengl.vbo.LowMemoryVertexBufferObject} or an extreme number of small {@link com.example.windows_home.andengine.andengine.opengl.vbo.HighPerformanceVertexBufferObject}/{@link com.example.windows_home.andengine.andengine.opengl.vbo.LowMemoryVertexBufferObject}s, where you can't afford to have any of the bufferdata to be kept in heap memory.</li>
 * <li>The content (color, vertices, texturecoordinates) of the {@link com.example.windows_home.andengine.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} is changed not often, or even better: never.</li>
 * </ol>
 * <p/>
 * (c) Zynga 2011
 *
...
public abstract class ZeroMemoryVertexBufferObject implements IVertexBufferObject {
	...
	/**
	 * When a non <code>null</code> {@link java.nio.ByteBuffer} is returned by this function, it is guaranteed that {@link com.example.windows_home.andengine.andengine.opengl.vbo.ZeroMemoryVertexBufferObject#releaseByteBuffer(java.nio.ByteBuffer)} is called.
	 * @return a {@link java.nio.ByteBuffer} to be passed to {@link com.example.windows_home.andengine.andengine.opengl.vbo.ZeroMemoryVertexBufferObject#onPopulateBufferData(java.nio.ByteBuffer)}.
	 */
