...
public class HoldDetector extends BaseDetector {
	...
	/**
	 * When {@link com.example.windows_home.andengine.andengine.input.touch.detector.HoldDetector#isHolding()} this method will call through to {@link com.example.windows_home.andengine.andengine.input.touch.detector.HoldDetector.IHoldDetectorListener#onHoldFinished(com.example.windows_home.andengine.andengine.input.touch.detector.HoldDetector, long, int, float, float).
	 */
	@Override
	public void reset() {
		if(this.mTriggering) {
