...
public class BitmapTextureAtlasTextureRegionFactory {
	 ...
	 * @param pAssetManager
	 * @param pAssetSubdirectory to load all files from "gfx/flowers" put "flowers" here (assuming, that you've used {@link com.example.windows_home.andengine.andengine.opengl.texture.atlas.bitmap.BitmapTextureAtlasTextureRegionFactory#setAssetBasePath(String)} with "gfx/" before.)
	 * @return
	 */
