package com.example.windows_home.andengine.andengine.input.sensor.location;
...
public class LocationSensorOptions extends Criteria {
	...
	/**
	 * @see {@link com.example.windows_home.andengine.andengine.input.sensor.location.LocationSensorOptions#setAccuracy(int)},
	 *      {@link com.example.windows_home.andengine.andengine.input.sensor.location.LocationSensorOptions#setAltitudeRequired(boolean)},
	 *      {@link com.example.windows_home.andengine.andengine.input.sensor.location.LocationSensorOptions#setBearingRequired(boolean)},
	 *      {@link com.example.windows_home.andengine.andengine.input.sensor.location.LocationSensorOptions#setCostAllowed(boolean)},
	 *      {@link com.example.windows_home.andengine.andengine.input.sensor.location.LocationSensorOptions#setEnabledOnly(boolean)},
	 *      {@link com.example.windows_home.andengine.andengine.input.sensor.location.LocationSensorOptions#setMinimumTriggerDistance(long)},
	 *      {@link com.example.windows_home.andengine.andengine.input.sensor.location.LocationSensorOptions#setMinimumTriggerTime(long)},
	 *      {@link com.example.windows_home.andengine.andengine.input.sensor.location.LocationSensorOptions#setPowerRequirement(int)},
	 *      {@link com.example.windows_home.andengine.andengine.input.sensor.location.LocationSensorOptions#setSpeedRequired(boolean)}.
	 */
