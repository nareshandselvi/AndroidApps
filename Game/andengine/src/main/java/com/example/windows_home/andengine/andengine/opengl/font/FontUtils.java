package com.example.windows_home.andengine.andengine.opengl.font;
...
public class FontUtils {
	 ...
	 * @param pFont
	 * @param pText
	 * @param pMeasureDirection If {@link com.example.windows_home.andengine.andengine.opengl.font.FontUtils.MeasureDirection#FORWARDS}, starts with the first character in the {@link CharSequence}. If {@link com.example.windows_home.andengine.andengine.opengl.font.FontUtils.MeasureDirection#BACKWARDS} starts with the last character in the {@link CharSequence}.
	 * @param pWidthMaximum
	...
	public static <L extends List<CharSequence>> L splitLines(final IFont pFont, final CharSequence pText, final L pResult, final AutoWrap pAutoWrap, final float pAutoWrapWidth) {
		/**
		 * TODO In order to respect already existing linebreaks, {@link com.example.windows_home.andengine.andengine.opengl.font.FontUtils#split(CharSequence, java.util.List)} could be leveraged and than the following methods could be called for each line.
		 */
		switch(pAutoWrap) {
			case LETTERS:
