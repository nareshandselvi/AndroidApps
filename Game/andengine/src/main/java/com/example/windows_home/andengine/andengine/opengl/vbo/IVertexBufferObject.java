...
public interface IVertexBufferObject extends IDisposable {
	...
	/**
	 * Mark this {@link com.example.windows_home.andengine.andengine.opengl.vbo.VertexBufferObject} as not not loaded to hardware.
	...
	/** Mark this {@link com.example.windows_home.andengine.andengine.opengl.vbo.VertexBufferObject} dirty so it gets updated on the hardware. */
	public void setDirtyOnHardware();

	/**
	 * @return the number of <code>float</code>s that fit into this {@link com.example.windows_home.andengine.andengine.opengl.vbo.IVertexBufferObject}.
	 */
	public int getCapacity();
	/**
	 * @return the number of <code>byte</code>s that fit into this {@link com.example.windows_home.andengine.andengine.opengl.vbo.IVertexBufferObject}.
	 */
