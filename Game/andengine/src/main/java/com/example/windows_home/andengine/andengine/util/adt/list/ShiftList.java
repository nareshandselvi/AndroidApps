 ...
 * Besides sparse allocations to increase the size of the internal Array, {@link com.example.windows_home.andengine.andengine.util.adt.list.ShiftList} is allocation free (unlike the {@link java.util.LinkedList} family).
 * 
