package com.example.windows_home.andengine.andengine.entity;
...
public interface IEntity extends IDrawHandler, IUpdateHandler, IDisposable {
	 ...
	 * @return all children (recursively!) that match the supplied {@link com.example.windows_home.andengine.andengine.entity.IEntityMatcher}.
	 */
	public ArrayList<IEntity> query(final IEntityMatcher pEntityMatcher);
	/**
	 * @param pEntityMatcher
	 * @return the first child (recursively!) that matches the supplied {@link com.example.windows_home.andengine.andengine.entity.IEntityMatcher} or <code>null</code> if none matches..
	 */
	 ...
	 * @param pEntityMatcher
	 * @return the first child (recursively!) that matches the supplied {@link com.example.windows_home.andengine.andengine.entity.IEntityMatcher} or <code>null</code> if none matches..
	 * @throws ClassCastException when the supplied {@link com.example.windows_home.andengine.andengine.entity.IEntityMatcher} matched an {@link com.example.windows_home.andengine.andengine.entity.IEntity} that was not of the requested subtype.
	 */
	...
	/**
	 * Immediately sorts the {@link com.example.windows_home.andengine.andengine.entity.IEntity}s based on their ZIndex. Sort is stable.
	 */
	public void sortChildren();
	/**
	 * Sorts the {@link com.example.windows_home.andengine.andengine.entity.IEntity}s based on their ZIndex. Sort is stable.
	 * In contrast to {@link com.example.windows_home.andengine.andengine.entity.IEntity#sortChildren()} this method is particularly useful to avoid multiple sorts per frame.
	 * @param pImmediate if <code>true</code>, the sorting is executed immediately.
	 * If <code>false</code> the sorting is executed before the next (visible) drawing of the children of this {@link com.example.windows_home.andengine.andengine.entity.IEntity}.
	 */
	public void sortChildren(final boolean pImmediate);
	/**
	 * Sorts the {@link com.example.windows_home.andengine.andengine.entity.IEntity}s based on the {@link java.util.Comparator} supplied. Sort is stable.
	...
	/**
	 * Will only be performed if {@link com.example.windows_home.andengine.andengine.entity.IEntity#isCullingEnabled()} is true.
	 *
