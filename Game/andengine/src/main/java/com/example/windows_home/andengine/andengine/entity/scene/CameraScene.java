...
public class CameraScene extends Scene {
	...
	/**
	 * {@link com.example.windows_home.andengine.andengine.entity.scene.CameraScene#setCamera(Camera)} needs to be called manually. Otherwise nothing will be drawn.
	 */
	public CameraScene() {
		this(null);
	}
