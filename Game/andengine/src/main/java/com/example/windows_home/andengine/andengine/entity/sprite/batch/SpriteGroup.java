package com.example.windows_home.andengine.andengine.entity.sprite.batch;
...
public class SpriteGroup extends DynamicSpriteBatch {
	...
	/**
	 * Instead use {@link com.example.windows_home.andengine.andengine.entity.sprite.batch.SpriteGroup#attachChild(BaseSprite)}.
	 */
	@Override
	@Deprecated
