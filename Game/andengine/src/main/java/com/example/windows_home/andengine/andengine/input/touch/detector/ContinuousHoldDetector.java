...
public class ContinuousHoldDetector extends HoldDetector implements IUpdateHandler {
	...
	/**
	 * When {@link com.example.windows_home.andengine.andengine.input.touch.detector.ContinuousHoldDetector#isHolding()} this method will call through to {@link HoldDetector.IHoldDetectorListener#onHoldFinished(HoldDetector, long, int, float, float)}.
	 */
	@Override
	public void reset() {
		super.reset();
