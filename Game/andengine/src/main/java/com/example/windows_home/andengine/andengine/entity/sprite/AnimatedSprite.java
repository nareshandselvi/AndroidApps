package com.example.windows_home.andengine.andengine.entity.sprite;
...
public class AnimatedSprite extends TiledSprite {
	...
	public static interface IAnimationListener {
		 ...
		 * @param pInitialLoopCount is {@link com.example.windows_home.andengine.andengine.entity.sprite.AnimatedSprite#LOOP_CONTINUOUS} when {@link com.example.windows_home.andengine.andengine.entity.sprite.AnimatedSprite} loops infinitely.
		 */
		public void onAnimationStarted(final AnimatedSprite pAnimatedSprite, final int pInitialLoopCount);
		/**
		 * @param pAnimatedSprite
		 * @param pOldFrameIndex equals {@link com.example.windows_home.andengine.andengine.entity.sprite.AnimatedSprite#FRAMEINDEX_INVALID}, the first time {@link com.example.windows_home.andengine.andengine.entity.sprite.AnimatedSprite.IAnimationListener#onAnimationFrameChanged(com.example.windows_home.andengine.andengine.entity.sprite.AnimatedSprite, int, int)} is called.
		...
		/**
		 * @param pAnimatedSprite
		 * @param pRemainingLoopCount is {@link com.example.windows_home.andengine.andengine.entity.sprite.AnimatedSprite#LOOP_CONTINUOUS} when {@link com.example.windows_home.andengine.andengine.entity.sprite.AnimatedSprite} loops infinitely.
		 * @param pInitialLoopCount is {@link com.example.windows_home.andengine.andengine.entity.sprite.AnimatedSprite#LOOP_CONTINUOUS} when {@link com.example.windows_home.andengine.andengine.entity.sprite.AnimatedSprite} loops infinitely.
		 */
