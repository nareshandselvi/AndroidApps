package com.example.windows_home.andengine.andengine.util.adt.list;
 ...
 * Besides sparse allocations to increase the size of the internal Array, {@link com.example.windows_home.andengine.andengine.util.adt.list.CircularList} is allocation free (unlike the {@link java.util.LinkedList} family).
 *
 * (c) Zynga 2012
 *
 * @author Greg Haynes
