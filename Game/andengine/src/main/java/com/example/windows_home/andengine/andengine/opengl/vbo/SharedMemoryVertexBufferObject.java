...
/**
 * Compared to {@link ZeroMemoryVertexBufferObject}, all {@link com.example.windows_home.andengine.andengine.opengl.vbo.SharedMemoryVertexBufferObject}s share a single {@link java.nio.ByteBuffer} which is used by whichever {@link com.example.windows_home.andengine.andengine.opengl.vbo.SharedMemoryVertexBufferObject} instance is currently buffering data,
 * at the cost of expensive data buffering (<b>up to <u>5x</u> slower!</b>) and a little synchronization overhead.
 * <p/>
 * Usually a {@link com.example.windows_home.andengine.andengine.opengl.vbo.SharedMemoryVertexBufferObject} is preferred to a {@link ZeroMemoryVertexBufferObject} when the following conditions need to be met:
 * <ol>
