...
/**
 * TODO Extract a common base class from {@link com.example.windows_home.andengine.andengine.opengl.vbo.VertexBufferObject} and {@link com.example.windows_home.andengine.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} (due to significant code duplication).
...
public abstract class VertexBufferObject implements IVertexBufferObject {
	 ...
	 * @param pCapacity
	 * @param pDrawType
	 * @param pAutoDispose when passing <code>true</code> this {@link com.example.windows_home.andengine.andengine.opengl.vbo.VertexBufferObject} loads itself to the active {@link VertexBufferObjectManager}. <b><u>WARNING:</u></b> When passing <code>false</code> one needs to take care of that by oneself!
	 * @param pVertexBufferObjectAttributes to be automatically enabled on the {@link ShaderProgram} used in {@link com.example.windows_home.andengine.andengine.opengl.vbo.VertexBufferObject#bind(ShaderProgram)}.
	 */
