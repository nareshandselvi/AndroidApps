...
public interface IOnAreaTouchListener {
	 ...
	 * 
	 * @return <code>true</code> if this {@link com.example.windows_home.andengine.andengine.entity.scene.IOnAreaTouchListener} has consumed the {@link TouchEvent}, <code>false</code> otherwise.
	 */
