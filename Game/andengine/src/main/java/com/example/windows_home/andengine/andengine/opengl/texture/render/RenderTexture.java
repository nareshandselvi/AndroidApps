package com.example.windows_home.andengine.andengine.opengl.texture.render;
...
/**
 * The general workflow with a {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture} is: {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#init(GLState)} -> {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#begin(GLState)} -> {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#end(GLState)} -> {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#destroy(GLState)}.
 *
 * (c) Zynga 2011
 *
...
public class RenderTexture extends Texture {
	...
	/**
	 * @param pGLState
	 * @throws RenderTextureInitializationException when this {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture} could not be initialized. The {@link GLException} contains the error code. When this exception is throw, all cleanup will be automatically performed through {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#destroy(GLState)}.
	 */
	...
	/**
	 * @see {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#end(GLState)},
	 * 		{@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#end(GLState, boolean, boolean}}.
	 */
	 ...
	 * 		{@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#end(GLState, boolean, boolean}}.
	 *
	 * @param pColor the {@link Color} to clear this {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture }.
	 */
	 ...
	 * 		{@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#end(GLState, boolean, boolean}}.
	 *
	 * @param pRed the red portion of the color to clear this {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture }.
	 * @param pGreen the green portion of the color to clear this {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture }.
	 * @param pBlue the blue portion of the color to clear this {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture }.
	 * @param pAlpha the alpha portion of the color to clear this {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture }.
	 */
	...
	/**
	 * @see {@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#begin(GLState)},
	 * 		{@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#begin(GLState, boolean, boolean)},
	 * 		{@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#begin(GLState, Color)},
	 * 		{@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#begin(GLState, float, float, float, float)},
	 * 		{@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#begin(GLState, boolean, boolean, Color)}.
	 * 		{@link com.example.windows_home.andengine.andengine.opengl.texture.render.RenderTexture#begin(GLState, boolean, boolean, float, float, float, float)}.
	 */
