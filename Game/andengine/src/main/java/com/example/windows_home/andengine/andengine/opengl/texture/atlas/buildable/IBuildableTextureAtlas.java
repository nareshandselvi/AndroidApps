package com.example.windows_home.andengine.andengine.opengl.texture.atlas.buildable;
...
public interface IBuildableTextureAtlas<S extends ITextureAtlasSource, T extends ITextureAtlas<S>> extends ITextureAtlas<S>{
	...
	/**
	 * Most likely this is not the method you'd want to be using, as the {@link ITextureAtlasSource} won't get built through this {@link com.example.windows_home.andengine.andengine.opengl.texture.atlas.buildable.BuildableTextureAtlas}.
	 * @deprecated Use {@link com.example.windows_home.andengine.andengine.opengl.texture.atlas.buildable.BuildableTextureAtlas#addTextureAtlasSource(ITextureAtlasSource)} instead.
	 */
	@Override
	@Deprecated
